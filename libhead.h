...
void modo_2(char board[15][15], int n, char* dicname, char* playbook_archive);
int point_word(char board[15][15], int n, jogada);
jogada *look_word(char board[15][15],int n,int linha,int coluna,int direcao, jogada* play);
